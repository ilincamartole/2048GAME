...
{
    return getBoard().estePlin() && getBoard().esteBlocaje(); // Verifică dacă tabla este plină și nu mai sunt mutări posibile
}
...
Joc2048* JocUsor::clone() const
{
    return new JocUsor(*this);
}